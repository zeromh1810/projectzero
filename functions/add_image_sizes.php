...
function dl_image_sizes( $sizes ) {
	...
	$add_sizes = array(
		...
		'header'	=> __( 'Tamaño personalizado del hero' ),
...
if ( function_exists( 'add_theme_support' ) ) {
	...
	add_image_size( 'works', 434, 290, true );			// Personalización del tamaño de trabajos
	add_image_size( 'header', 900, 260, true );		// Personalización del tamaño del header
	...
	add_image_size( 'blog', 400, 195, true );		// Personalización del tamaño de los thumbnails
